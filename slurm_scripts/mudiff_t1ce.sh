...
#SBATCH --error=log_mudiff_t1ce.%J.err
#SBATCH --output=log_mudiff_t1ce.%J.out

# Print job information
echo "====================================="
echo "SLURM JOB: T1CE Synthesis with MU-Diff"
echo "====================================="
...
# Run the complete T1CE synthesis experiment (train + test)
echo "Starting T1CE synthesis experiment..."
echo "Command: python run.py -c cfg/local.yaml -e synthesize_T1CE"
echo "This will:"
echo "  1. Train the MU-Diff model for T1CE synthesis"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo
    echo "====================================="
    echo "T1CE synthesis experiment completed successfully!"
    echo "====================================="
    echo "Results saved in: ../results/synthesize_T1CE/"
    echo "Check the following outputs:"
    echo "  - Model checkpoints: ../results/synthesize_T1CE/gen_diffusive_*.pth"
    echo "  - Training samples: ../results/synthesize_T1CE/sample_discrete_epoch_*.png"
    echo "  - Validation metrics: ../results/synthesize_T1CE/val_*.npy"
    echo "  - Test results: ../results/synthesize_T1CE/generated_samples/"
else
    echo
    echo "====================================="
    echo "ERROR: T1CE synthesis experiment failed!"
    echo "====================================="
    echo "Exit code: $EXIT_CODE"
    echo "Check error logs: log_mudiff_t1ce.$SLURM_JOB_ID.err"
    exit $EXIT_CODE
fi
