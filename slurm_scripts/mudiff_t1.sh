...
#SBATCH --error=log_mudiff_t1.%J.err
#SBATCH --output=log_mudiff_t1.%J.out

# Print job information
echo "====================================="
echo "SLURM JOB: T1 Synthesis with MU-Diff"
echo "====================================="
...
# Run the complete T1 synthesis experiment (train + test)
echo "Starting T1 synthesis experiment..."
echo "Command: python run.py -c cfg/local.yaml -e synthesize_T1"
echo "This will:"
echo "  1. Train the MU-Diff model for T1 synthesis"
...
python run.py -c cfg/local.yaml -e synthesize_T1
...
if [ $EXIT_CODE -eq 0 ]; then
    echo
    echo "====================================="
    echo "T1 synthesis experiment completed successfully!"
    echo "====================================="
    echo "Results saved in: ../results/synthesize_T1/"
    echo "Check the following outputs:"
    echo "  - Model checkpoints: ../results/synthesize_T1/gen_diffusive_*.pth"
    echo "  - Training samples: ../results/synthesize_T1/sample_discrete_epoch_*.png"
    echo "  - Validation metrics: ../results/synthesize_T1/val_*.npy"
    echo "  - Test results: ../results/synthesize_T1/generated_samples/"
else
    echo
    echo "====================================="
    echo "ERROR: T1 synthesis experiment failed!"
    echo "====================================="
    echo "Exit code: $EXIT_CODE"
    echo "Check error logs: log_mudiff_t1.$SLURM_JOB_ID.err"
    exit $EXIT_CODE
fi
